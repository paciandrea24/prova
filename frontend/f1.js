document.addEventListener('DOMContentLoaded', async () => {
    ...
    // ====================================================
    // La tabella asset -> .glb sta in un modulo condiviso: l'anteprima
    // esplorabile carica gli stessi file, e due copie divergerebbero.
    const SCENERY_ASSET_PATHS = SceneryAssetPaths.PERCORSI;
