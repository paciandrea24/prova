...
(function (root, factory) {
    ...
    // ⚠️ I COLORI DEI CARTELLONI SPONSOR NON STANNO PIÙ QUI. Erano
    // `CITTA_SPONSOR`, sei coppie fondo/banda riusate a rotazione sui venti
    // marchi; dal 2026-09-11 ogni sponsor ha la sua coppia fissa e la tinta
    // viaggia accanto al nome, in `sponsorAtlas.js`. Un marchio ha i suoi
    // colori come ha il suo nome: separarli faceva sì che due sponsor diversi
    // si presentassero vestiti uguali.
